...
const VIDEO_PROVIDER_OPTIONS: {
...
}[] = [
  {
    id: "cloudinary",
    label: "Cloudinary",
    hint: "מומלץ לשמירת מבנה היהלום — שיפור צבע וחדות ללא יצירה מחדש",
  },
  {
    id: "gemini",
    label: "Gemini (Veo)",
    hint: "עלול לשנות צורת אבנים ושיבוצים — רק כשמכסת הווידאו נגמרה",
  },
];
    ...
    <div className="space-y-4 rounded-none border border-gold/25 bg-gold/[0.03] p-4">
      ...
      <p className="text-[11px] font-light text-muted-foreground">
        {mediaType === "image"
          ...
          : videoProvider === "gemini"
            ? "יוצר קליפ חדש ב-Veo — עלול לשנות מעט את צורת היהלום. לשמירה מדויקת השתמשו ב-Cloudinary."
            : "ייצוב, חידוד וצבע — שומר על מבנה התכשיט המקורי."}
      </p>
